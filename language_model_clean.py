...
if __name__ == '__main__':
    ...
    model_save_path = './models/'+ lm_type + '/snapshot2/' + str(data_size) + '_data_' + str(test_canary_frequency) + '_test_can_' + '_' + str(canary_format) + '_can_fmt_' + str(password_type) + '_pw_type_' + str(learning_rate) + '_lr'
